...
const HeroSection = () => {
  ...
  return (
    <section
      id="hero-about"
      className="bg-transparent text-white min-h-screen flex items-center justify-center px-4 sm:px-6 py-16 md:py-24 relative"
    >
      <div className="ml-0 sm:ml-12 md:ml-24 lg:ml-36 xl:ml-44 max-w-7xl mx-auto w-full flex flex-col-reverse md:flex-row items-center">
        {/* Text Section */}
        <div className="flex-1 text-center md:text-left space-y-6">
          ...
          <a
            ...
            className="inline-flex items-center gap-3 px-6 py-3 bg-white/10 text-white font-semibold rounded-lg shadow-md border border-transparent hover:border-white/20 transition-all duration-300"
          >
          ...
          {/* Stats Section */}
<div className="mt-8 grid grid-cols-2 sm:grid-cols-4 gap-y-6 gap-x-8 text-center md:text-left text-gray-300">
  <div>
